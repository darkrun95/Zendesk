...
"""
Find the page range to be displayed for pagination, at the given page.
"""
def calculate_page_range(page_value, total_pages):
		...
		if not response.ok:
			...
			if count_tickets != 0:
				...
				(
					...
					upper_limit, 
					upper_limit_val
				) = calculate_page_range(page_value, total_pages)
			else:
				total_pages = 0
